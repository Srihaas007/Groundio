function GroundioLogo({ className = "w-12 h-12" }) {
  return (
    <svg className={className} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 1200" fill="none">
      <rect width="1200" height="1200" fill="#646cff" rx="3"/>
      <g opacity=".5">
        <g opacity=".5">
          <path 
            fill="#FAFAFA" 
